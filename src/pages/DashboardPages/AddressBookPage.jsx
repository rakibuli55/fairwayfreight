        ...
        <div className="mt-10 p-10 border border-[#F0F0F0] rounded-[12px]">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="flex items-center gap-2 py-[14px] px-7 font-bold text-white rounded-[40px] bg-primaryGreen duration-200 ease-in-out border-[2px] border-primaryGreen hover:bg-transparent hover:text-primaryGreen"
            >
              <LuCirclePlus />
              Add New Address
            </Link>
