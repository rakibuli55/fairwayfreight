    ...
    <section className="py-[56px] custom-xs:py-7 px-[200px] extra-large:px-[100px] custom-2xl:px-[100px] custom-xl:px-20 custom-lg:px-10 max-md:px-10 custom-xs:!px-6">
      <div>
        ...
        <div className="pt-[125px] custom-2xl:pt-20 custom-xl:pt-[60px] custom-lg:pt-[60px] max-md:pt-[60px] custom-xs:!pt-[30px]">
          ...
          <p className="text-center mb-[64px] custom-md:mb-10 custom-sm:mb-10 custom-xs:mb-[30px]">Enter your email to get a verification code.</p>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mt-10 custom-xs:mt-6">
              <button className={`w-full ${isLoading ? 'opacity-50 pointer-events-none' : 'opacity-100 pointer-events-auto'}`}>
                <PrimaryButton text={isLoading ? 'Submitting' : 'Submit'} className="p-4 w-full bg-primaryGreen text-white font-bold border-[2px] border-primaryGreen duration-200 ease-in-out hover:bg-transparent hover:text-primaryGreen rounded-[40px] justify-center custom-xs:py-3" />
              </button>
            </div>
          </form>
        </div>
