...
const AddedAddressBook = ({ address }) => {
  ...
  return (
    <div className="mt-10 p-6 bg-[#f6f6f6] rounded-[8px] relative">
      ...
      <p className="h-8 w-8 bg-white flex items-center justify-center absolute top-5 right-5 rounded-[30px] cursor-pointer" onClick={() => setSelectedAddress(address)}>
        <CiEdit />
      </p>
